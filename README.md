...
The RDBMS is the database system iself. SQL is the language that is used to interact with it.

1. Why do tables need a `primary key`?

The primary key is a way to uniquely identify table rows.
...
Need a table to hold the foreign keys.
